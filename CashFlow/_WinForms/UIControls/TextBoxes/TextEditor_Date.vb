...
Public Class TextEditor_Date
    Inherits TextEditor
    Implements ITextBoxData
    ...
    Public Property Value As Object Implements ITextBoxData.Value
        Get
            Return dValue
        End Get
        Set(value As Object)
    ...
    Public ReadOnly Property VisualText As String Implements ITextBoxData.VisualText

    Public Sub AssignValue(InputValue As Date?)
        dValue = InputValue
        LoadVisualText()
        LoadData()
    End Sub

    Public Sub AssignValue(InputValue As String) Implements ITextBoxData.AssignValue
    ...
    Private Sub LoadVisualText()

        If Me.dValue.HasValue Then
            _VisualText = dValue.Value.ToString("dd/MM/yyyy")
        Else
