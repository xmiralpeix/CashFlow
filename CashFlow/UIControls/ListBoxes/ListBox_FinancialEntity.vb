...
Public Class ListBox_FinancialEntity
    Inherits ListBox
    Implements IListBoxData

    Private _entity As FinancialEntity
    ...
    Public Overrides Sub OnSearchClick()
        ...
        Dim findBehaviour As IFindBehaviour = New EntityIDsFinder(New FinancialEntityEditor())
