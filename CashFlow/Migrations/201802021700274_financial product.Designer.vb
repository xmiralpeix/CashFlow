...
Namespace Migrations
    ...
    Public NotInheritable Partial Class financialproduct
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(financialproduct))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201802021700274_financial product"
            End Get
        End Property
